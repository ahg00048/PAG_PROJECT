...
namespace PAG {
    ...
    const glm::vec3& Renderer::getCurrentModelDiff() {
        ...
        _models[_selectedModel].getMaterial()->getDiffuse();
    }
    ...
    const glm::vec3& Renderer::getCurrentModelAmb() {
        ...
        _models[_selectedModel].getMaterial()->getAmbient();
    }
    ...
    const glm::vec3& Renderer::getCurrentModelSpec() {
        ...
        _models[_selectedModel].getMaterial()->getSpecular();
    }
    ...
    float Renderer::getCurrentModelPhongExp() {
        ...
        _models[_selectedModel].getMaterial()->getPhongExp();
    }
